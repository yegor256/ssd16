...
\lnPitch{\pptPic{0.4}{java-abstraction2}}
...
\lnPitch{\pptPic{0.7}{encapsulation2}}

\lnPitch{
  ``Encapsulation Covers Up Naked Data'' (2016)\par
  \pptQR[1in]{https://www.yegor256.com/2016/11/21/naked-data.html}\par
  \pptPic{0.4}{naked1}\par
  \pptPic{0.4}{naked2}
}
...
\lnPitch{\pptChapter[SOLID]{SOLID Principles by Uncle Bob}}
...
\lnPitch{\pptChapter[Contracts]{Design by Contract by Bertrand Meyer}}

\lnPitch{\pptPic{0.5}{contracts}}

\lnPitch{\pptChapter[DRY]{Don't Repeat Yourself (DRY)}}

\lnPitch{\pptPic{0.5}{dry}}

\lnPitch{\pptChapter[YAGNI]{You Ain't Gonna Need It (YAGNI)}}

\lnPitch{\pptPic{0.7}{yagni}}

\lnPitch{\pptChapter[IoC]{Inversion of Control}}
...
\lnPitch{\pptChapter[FP]{OOP vs. Functional Programming}}
...
\lnPitch{
  \begin{multicols}{2}
    \innoBook{stroustrup2014programming}
    \par\columnbreak
    \innoBook{mclaughlin2006head}
  \end{multicols}
}
