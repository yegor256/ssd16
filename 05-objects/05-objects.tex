...
\lnPitch{
  \pptQuote
    {../faces/alan-kay}
    {I invented the term \hs{object-oriented}, and I can tell you I did not have C++ in mind}
...
\lnPitch{\pptSection{C++}}

\lnQuote
  {../bibliography/book-covers/stroustrup2014programming.jpg}
...
\lnPitch{\pptSection{Smalltalk}}

\lnQuote
  {../bibliography/book-covers/goldberg1983smalltalk.jpg}
  {An object consists of some private memory and a set of operations}
  {goldberg1983smalltalk}

\lnPitch{\pptSection{Java}}

\lnQuote
  {../bibliography/book-covers/evans2018java.jpg}
...
\lnPitch{
  ...
  \pptPic{0.8}{null}\par
  \hs{Null References, The Billion Dollar Mistake}\\
  presentation by \nospell{Tony Hoare},
