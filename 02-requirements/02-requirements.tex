...
\plush[2]{\pptQuote{../bibliography/book-covers/martin2002}{If you are lucky, you start a project with a clear picture of what you want the system to be. The design of the system is a vital image in your mind. If you are luckier still, the clarity of that design makes it to the first release.}{\emph{Agile Software Development. Principles, Patterns, and Practices}, Robert Martin}}

\plush[2]{\pptQuote{../bibliography/book-covers/ca1}{It's the responsibility of a programmer to make sure the tasks he is working
...
\plush[10]{\pptQuote{../bibliography/book-covers/uml-book}{There is no standard way to write the content of a use case, and different formats work well in different cases}{UML Distilled \br Martin Fowler}}
...
\plush[3]{\pptQuote{../bibliography/book-covers/cmmi-vv}{Two different questions may be asked by a project team:
...
\plush[2]{\pptQuote{../bibliography/book-covers/boehm}{For software decisions, the most critical and difficult of these inputs to provide are estimates of the cost of a proposed software project.}{Software Engineering Economics \br \nospell{Barry W. Boehm}}}
